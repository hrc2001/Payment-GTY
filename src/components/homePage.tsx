...
export default function HomePage() {
  ...
  return (
    <div
      ...
      <div className="-top-2 right-0 flex items-center gap-0 rotate-180 h-[50px] max-sm:hidden w-full overflow-hidden fixed z-999">
      ...
      <div className="relative z-10 grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 max-sm:pt-18 sm:pb-20 gap-16 sm:p-30">
        <div
          className={`flex flex-col items-center gap-2 transition-all duration-700 ${
            isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
          }`}>
          <h1 className="sm:text-5xl text-4xl font-bold text-center text-white mb-4">
        ...
        <div className="flex flex-col items-center justify-start  gap-10 w-full max-w-6xl !pt-20 min-h-[1290px]">
          ...
          <section
            ...
            <div className="p-8 md:p-12">
              <h2 className="sm:text-2xl text-xl md:text-3xl font-bold text-center text-white mb-8">
                With Payment Gateway, you can
              </h2>

              <div className="flex flex-col items-center justify-center mb-12">
                {/* Animated feature display */}
                <div className="h-16 sm:h-20 overflow-hidden relative w-full max-w-md">
                  {features.map((feature, index) => (
                    <div
                      ...
                      <div className="sm:text-xl text-base md:text-2xl font-semibold text-white bg-blue-500/30 sm:py-3 py-2 sm:px-6 px-4 rounded-lg backdrop-blur-sm border border-white/20">
                        {feature}
                      </div>
                    </div>
                  ))}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 items-center justify-center">
                <Link
                  ...
                  <div className="relative sm:w-28 w-20 sm:h-30 h-20 mb-4 transform group-hover:scale-110 transition-transform duration-300">
                    <Image
                      src={paypal}
                      alt="Paypal"
                      fill
      ...
      <AnimatedEarth />
      <div className="relative flex max-xl:flex-col-reverse xl:flex-row justify-center items-center bg-blue-300 sm:py-20 py-10 w-auto h-fit sm:gap-10 gap-5">
        <Image
          src={payment2}
          alt="payment"
          className="object-contain sm:h-[400px] h-[250px] w-fit"
        />

        {/* Developer Section + Chandelier */}
        <div className="relative flex flex-col justify-center max-xl:items-center xl:items-start gap-5 max-xl:pt-20">
          {/* Chandelier + Glow */}
          <div className="absolute max-xl:-top-20 xl:-top-46 max-xl:left-1/2 xl:left-1/10 max-sm:-top-10 max-sm:left-1/2 transform -translate-x-1/2 flex flex-col items-center z-0">
            <Image
              src={chandelier}
              alt="chandelier"
              className="object-contain sm:h-[100px] h-[80px] w-fit z-10"
            />
            <div className="w-64 h-64 bg-yellow-100 opacity-60 blur-3xl rounded-full -mt-10 animate-light" />
          </div>

          <h3 className="sm:text-3xl text-2xl font-bold z-50">Developer</h3>
          <p className="text-black max-xl:text-center sm:text-xl text-base flex-wrap max-w-2xl">
          ...
          <button className="animated-button bg-blue-500 hover:bg-blue-700 text-white font-bold sm:text-lg text-base sm:py-4 py-2 sm:px-8 px-4 rounded-lg cursor-pointer">
            Learn More
          </button>
        </div>
      </div>
      ...
      <div className="text-white sm:text-2xl text-base font-bold w-full flex items-center sm:text-center text-start justify-between bg-white-500/30 py-3 px-6 rounded-lg backdrop-blur-sm border border-white/20 ">
        Supercharge your business with Payment Gateway
        <button
          className="animated-button bg-blue-500/30 sm:py-3 py-2 sm:px-6 px-4 sm:text-lg text-base rounded-lg backdrop-blur-sm border border-white/20 cursor-pointer text-white font-medium relative"
